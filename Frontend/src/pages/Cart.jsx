            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className={`absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full  ${showAddress? "cursor-pointer":""}`}>
                               {addresses.map((add,idx)=>( <p onClick={() =>{setSelectedAddress(add); setShowAddress(false)} }className="text-gray-500 p-2 hover:bg-gray-100">
