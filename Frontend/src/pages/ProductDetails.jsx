        ...
        <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                  ...
                  <p>(4)</p>
                    ...
                    <div className="flex items-center mt-10 gap-4 text-base">
                        <button onClick={()=>addToCart(product._id)} className="w-full py-3.5 cursor-pointer font-medium bg-gray-200 text-gray-800/80 hover:bg-gray-200 transition" >
                            Add to Cart
                        </button>
            ...
            <div className="flex flex-col items-center mt-20">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:grid-cols-4 lg:grid-cols-5  mt-6 md:gap-6">
                    {relatedProducts.filter((product)=>product.inStock).map((item,idx)=>(<ProductCard key={idx} product={item} />))}
                </div>
